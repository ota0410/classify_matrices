...
data_x = np.array(h5py.File("/home/s1411506/ota/kfold/BICG.h5",'r').get('data_x'))
label_y = np.array(h5py.File("/home/s1411506/ota/kfold/BICG.h5",'r').get('label_y'))
